...
plot(smallPowerData$Global_active_power ~ smallPowerData$DateTime, type="l", ylab="Global Active Power (kilowatts)", xlab="")

# copy line plot to png device and close file
